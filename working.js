...
var aarSection = `
  ...
  function resetEmailInputSection() {
        ...
        if (emailInputSection) {
            ...
            // Additionally, you can reset any other properties or values as needed
            // For example, clear the input value
            var emailInput = emailInputSection.querySelector('.kv-ee-form-control');
            if (emailInput) {
                emailInput.value = '';
            }
        }
...
function addClassToElementByClass(oldClass, newClass, aarSection) {
            ...
            subscribeButton.addEventListener('click', function () {
                ...
                if (emailInput && emailInput.value.trim() !== '' && isValidEmail(emailInput.value)) {
                    ...
                    if (form) {
                        ...
                        form.submit();
                        addClassToElementByClass('kv-ee-contact-form-success', 'kv-ee-show', aarSection);
                    }
                } else {
  ...
  window.addEventListener('load', onPageLoad(aarSection));
